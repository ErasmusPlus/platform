...
return [
    ...
    */
    'attributes' => [ 
			...
			'password' => 'κωδικός' , 
			'surname_en' => 'Surname (όπως αναγράφεται στο διαβατήριό σας)' ,
			'name_en' => 'Name' ,
			'fathersname'  => 'Όνομα Πατρός' ,
			'mothersname'  => 'Όνομα Μητρός' ,
			'age'  => 'Ηλικία' ,
			'idno' => 'Αριθμός Δελτίου Ταυτότητας' ,
			'birthplace' => 'Τόπος Γεννήσεως/Place of Birth',
			'birthdate' => 'Τόπος Γεννήσεως/Place of Birth',
			'prefecture' => 'Νομός/Prefecture',
			'citizenship' => 'Υπηκοότητα/Citizenship',
			'address_el' =>'Διεύθυνση Κατικίας',
			'address_en' => 'Address (με λατινικούς χαρακτήρες)',
			'nο_el' => 'Αριθμός',
			'city_el' =>'Πόλη',
			'city_en' =>'City',
			'tk' => 'ΤΚ',
			'tel' => 'Σταθερό τηλέφωνο',
			'mobtel' => 'Κινητό τηλέφωνο',
			'email' => 'Email',
			
			'iddate' => 'Ημ/νία έκδοσης ταυτότητας',
			'idloc' => 'Αρχή Έκδοσης ταυτότητας',
			'amka' => 'ΑΜΚΑ',
